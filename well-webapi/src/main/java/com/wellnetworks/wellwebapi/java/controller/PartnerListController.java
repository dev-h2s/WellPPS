...
public class PartnerListController {
    ...
    //거래처 회원가입 리스트
    @GetMapping("business/opening")
    public ResponseEntity<?> getPartnerOpeningList(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.by(Sort.Direction.DESC, "signRequestDate"));
        Page<WellPartnerSignInfoDTO> partnersPage = wellPartnerService.getAllPartnerOpening(pageable);
    ...
    public ResponseEntity<String> patchPartner(HttpServletRequest httpServletRequest
            , @RequestPart(value = "updateDTO") @ModelAttribute @Valid WellPartnerUpdateDTO updateDTO, @PathVariable String partnerIdx) {
        MultipartHttpServletRequest multiRequest = (MultipartHttpServletRequest) httpServletRequest;
    ...
    public ResponseEntity<Map<String, Object>> getPartnerOpeningList(
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.by(Sort.Direction.DESC, "signRequestDate"));
        Page<WellPartnerSignSearchDTO> partnersPage = wellPartnerService.getAllPartnerOpeningSearch(pageable,ceoName, ceoTelephone, partnerName, discountCategory, registrationStatus, openingStatus);
