...
public interface WellGroupRepository extends CrudRepository<WellEmployeeManagerGroupEntity, String> {
    ...
    Optional<WellEmployeeManagerGroupEntity>findByemployeeManagerGroupKey(String groupPermissionKey);
    ...
    Optional<Integer> deleteByemployeeManagerGroupKey(String groupPermissionKey);
}
